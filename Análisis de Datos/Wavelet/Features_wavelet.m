function [M_features,ritmo,coeff] = Features_wavelet(eeg,muestras,c,waveletFunction,banda,op)
...
%o op: vector de caracteristicas deseadas [power,media,desviacion,curtosis,asimetria,zc]=[1,1,1,1,1]
%arreglar dimension
...
for i=1:6    
    if op(i)==0
       features(:,i)=[]; %eliminar columna no deseada
    end
end
M_features = features;
coeff = cD;
